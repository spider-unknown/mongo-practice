...
Route::get('/illness/edit/{id}', 'IllnessController@edit')->name('illness.edit');
...
Route::get('/medicine/create', 'JambylMedicineController@create')->name('medicine.create');
Route::get('/medicine/edit/{id}', 'JambylMedicineController@edit')->name('medicine.edit');
...
Route::get('/sanatory/create', 'SanatoryController@create')->name('sanatory.create');
Route::get('/sanatory/edit/{id}', 'SanatoryController@edit')->name('sanatory.edit');
...
Route::get('/sanatory/arman/create', 'SanatoryArmanController@create')->name('sanatory.arman.create');
Route::get('/sanatory/arman/edit/{id}', 'SanatoryArmanController@edit')->name('sanatory.arman.edit');
...
Route::get('/sanatory/kazakhstan/create', 'SanatoryKazakhstanController@create')->name('sanatory.kazakhstan.create');
Route::get('/sanatory/kazakhstan/edit/{id}', 'SanatoryKazakhstanController@edit')->name('sanatory.kazakhstan.edit');
